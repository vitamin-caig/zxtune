...
namespace
{
  ...
  private:
    ...
    public:
      ...
      void SetTextSection(uint32_t address, Binary::DataView content)
      {
  ...
  private:
    ...
    {
    public:
      void SetRom(uint32_t offset, Binary::DataView content) override
      {
        Rom.Account(offset, content);
      }
      
      void SetSaveState(uint32_t offset, Binary::DataView content) override
      {
    ...
    private:
      struct Area
      {
        ...
        void Account(uint32_t offset, Binary::DataView content)
        {
          ++ChunksCount;
  ...
  private:
    ...
    public:
      ...
      void SetRom(uint32_t addr, Binary::DataView content) override
      {
