...
JNIEXPORT jlong JNICALL Java_app_zxtune_core_jni_GlobalOptions_getProperty__Ljava_lang_String_2J(JNIEnv* env,
                                                                                                 jobject /*self*/,
                                                                                                 jstring propName,
                                                                                                 jlong defVal)
{
...
JNIEXPORT void JNICALL Java_app_zxtune_core_jni_GlobalOptions_setProperty__Ljava_lang_String_2J(JNIEnv* env,
                                                                                                jobject /*self*/,
                                                                                                jstring propName,
                                                                                                jlong value)
{
