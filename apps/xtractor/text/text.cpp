...
extern const Char FLAT_SUBPATH_DESC[] = {
  's','t','o','r','e',' ','r','e','s','u','l','t',' ','i','n',' ','f','l','a','t',' ','f','i','l','e','s',' ',
  'l','i','s','t',' ','i','n','s','t','e','a','d',' ','o','f',' ','d','i','r','e','c','t','o','r','y',' ','s',
  't','r','u','c','t','u','r','e',0
};
extern const Char FLAT_SUBPATH_KEY[] = {
  'f','l','a','t','_','s','u','b','p','a','t','h',0
};
extern const Char FULL_SOURCE_PATH_DESC[] = {
  'u','s','e',' ','f','u','l','l',' ','i','n','p','u','t',' ','f','i','l','e',' ','p','a','t','h',' ','a','s',
  ' ','a',' ','t','a','r','g','e','t',' ','d','i','r','e','c','t','o','r','y',' ','n','a','m','e',' ','i','n',
  's','t','e','a','d',' ','o','f',' ','f','i','l','e','n','a','m','e',0
};
extern const Char FULL_SOURCE_PATH_KEY[] = {
  'f','u','l','l','_','s','o','u','r','c','e','_','p','a','t','h',0
};
...
extern const Char SAVE_THREADS_KEY[] = {
  's','a','v','e','_','t','h','r','e','a','d','s',0
};
extern const Char TARGET_DIR_DESC[] = {
  't','a','r','g','e','t',' ','d','i','r','e','c','t','o','r','y',' ','t','o',' ','s','t','o','r','e',' ','d',
  'a','t','a','.',' ','D','e','f','a','u','l','t',' ','i','s',' ','X','T','r','a','c','t','o','r',0
};
extern const Char TARGET_DIR_KEY[] = {
  't','a','r','g','e','t','_','d','i','r',0
};
