  ...
  void ShowOptions()
  {
    ...
    static const OptionDesc OPTIONS[] =
    {
      ...
      OptionDesc(Parameters::ZXTune::Sound::Backends::Mp3::BITRATE,
                 ...
                 EMPTY),
      OptionDesc(Parameters::ZXTune::Sound::Backends::Mp3::VBR,
                 Text::INFO_OPTIONS_SOUND_BACKENDS_MP3_VBR,
                 EMPTY),
      OptionDesc(Parameters::ZXTune::Sound::Backends::Mp3::ABR,
                 Text::INFO_OPTIONS_SOUND_BACKENDS_MP3_ABR,
                 EMPTY),
      ...
      OptionDesc(Parameters::ZXTune::Sound::Backends::Ogg::ABR,
                 Text::INFO_OPTIONS_SOUND_BACKENDS_OGG_ABR,
                 EMPTY),
