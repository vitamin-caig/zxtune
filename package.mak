...
package:
	...
	@$(MAKE) $(pkg_file) > $(pkg_dir)/packaging.log 2>&1
...
$(pkg_file): $(pkg_manual) $(pkg_debug)
	...
	zip -9Dj $@ $(target) ../zxtune.conf $(pkg_additional_files)
	zip -9Djm $@ $<
...
$(pkg_debug): $(pkg_log)
	$(info Packacking debug information and build log)
	zip -9Djm $@ $(target).pdb $(pkg_log)
