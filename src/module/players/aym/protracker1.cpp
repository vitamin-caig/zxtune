...
namespace ProTracker1
{
  ...
  public:
    ...
    void SetSample(uint_t index, const Formats::Chiptune::ProTracker1::Sample& sample) override
    {
      Data->Samples.Add(index, Sample(sample));
    }

    void SetOrnament(uint_t index, const Formats::Chiptune::ProTracker1::Ornament& ornament) override
    {
