...
* @file
*
* @brief  MIDI-based stream chiptunes support implementation
*
...
namespace Module
{
  namespace MIDI
  {
    ...
    public:
      ...
      virtual void GetData(Devices::MIDI::DataChunk& res) const
      {
        if (Delegate->IsValid())
        {
    ...
    public:
      ...
      virtual MIDI::DataIterator::Ptr CreateDataIterator() const
      {
