...
#pragma pack(pop)
  ...
  Renderer::Ptr CreateASCRenderer(Information::Ptr info, ASCTrack::ModuleData::Ptr data, AYM::Chip::Ptr device);
  ...
  public:
    ...
    {
      return CreateASCRenderer(Info, Data, AYM::CreateChip(target));
    }
