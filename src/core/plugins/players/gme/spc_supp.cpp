...
namespace Module::SPC
{
  ...
  public:
    ...
    SpectrumState GetState() const override
    {
      ...
      const uint_t noisePitch = noise != 0 ? dsp.GetNoisePitch() : 0;
      for (uint_t chan = 0; active != 0 && chan != 8; ++chan)
      {
        ...
        const uint_t pitch = isNoise ? noisePitch : dsp.GetPitch(chan);
  ...
  private:
    ...
    public:
      ...
      uint_t GetNoisePitch() const
      {
        ...
        static const uint_t NOISE_FREQS[32] = {0,    16,   21,   25,   31,   42,   50,   63,    83,    100,  125,
                                               167,  200,  250,  333,  400,  500,  667,  800,   1000,  1300, 1600,
                                               2000, 2700, 3200, 4000, 5300, 6400, 8000, 10700, 16000, 32000};
