...
{
  //TODO: fix name
  class PluginsEnumeratorInternal
  {
  public:
    typedef boost::shared_ptr<const PluginsEnumeratorInternal> Ptr;
    virtual ~PluginsEnumeratorInternal() {}
  ...
  class PluginsEnumerator : public PluginsRegistrator
                          , public PluginsEnumeratorInternal
  {
  public:
    //resolve subpath
