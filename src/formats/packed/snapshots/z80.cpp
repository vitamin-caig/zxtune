...
namespace Formats::Packed
{
  namespace Z80
  {
    struct Version1_45
    {
      ...
      static Container::Ptr Decode(Binary::InputStream& stream);
    };
    ...
    Container::Ptr Version1_45::Decode(Binary::InputStream& stream)
    {
    ...
    auto DecodeNew(Binary::InputStream& stream)
    {
    ...
    Container::Ptr Version2_0::Decode(Binary::InputStream& stream)
    {
      return DecodeNew(stream);
    }

    Container::Ptr Version3_0::Decode(Binary::InputStream& stream)
    {
      return DecodeNew(stream);
    }
  ...
  Decoder::Ptr CreateZ80V145Decoder()
  {
    ...
    return MakePtr<Z80::Decoder<Z80::Version1_45>>(std::move(format));
  }

  Decoder::Ptr CreateZ80V20Decoder()
  {
    return MakePtr<Z80::Decoder<Z80::Version2_0>>();
  }

  Decoder::Ptr CreateZ80V30Decoder()
  {
    return MakePtr<Z80::Decoder<Z80::Version3_0>>();
  }
}  // namespace Formats::Packed
