...
namespace Formats::Packed
{
  namespace CompiledASC
  {
    ...
    using ParseFunc = Chiptune::Container::Ptr (*)(const Binary::Container&, Chiptune::ASCSoundMaster::Builder&);
    ...
    const VersionTraits VERSION0 = {
        ...
        &Chiptune::ASCSoundMaster::Ver0::Parse,
        &Chiptune::ASCSoundMaster::Ver0::InsertMetaInformation,
    };
    ...
    const VersionTraits VERSION1 = {
        ...
        VERSION1_FORMAT,
        &PlayerTraits::Create<PlayerVer0>,
        &Chiptune::ASCSoundMaster::Ver1::Parse,
        &Chiptune::ASCSoundMaster::Ver1::InsertMetaInformation,
    };
    ...
    {
    public:
      explicit Decoder(const VersionTraits& version)
        : Version(version)
      ...
      Container::Ptr Decode(const Binary::Container& rawData) const override
      {
        ...
        auto& stub = Chiptune::ASCSoundMaster::GetStubBuilder();
  ...
  {
    return MakePtr<CompiledASC::Decoder>(CompiledASC::VERSION0);
  }

  Decoder::Ptr CreateCompiledASC1Decoder()
  {
    return MakePtr<CompiledASC::Decoder>(CompiledASC::VERSION1);
  }

  Decoder::Ptr CreateCompiledASC2Decoder()
  {
    return MakePtr<CompiledASC::Decoder>(CompiledASC::VERSION2);
  }
}  // namespace Formats::Packed
