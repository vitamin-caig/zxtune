...
namespace Formats::Packed
{
  namespace Hrust2
  {
    ...
    namespace Version1
    {
      ...
      public:
        ...
        {
          if (Data.Size() < sizeof(FormatHeader))
          {
            return false;
          }
        ...
        std::size_t GetUsedSizeWithPadding() const
        {
          ...
          if (const std::size_t pad = MatchedSize(padding, {HRUST2_1_PADDING}))
          {
      ...
      private:
        const Binary::Format::Ptr Format = Binary::CreateFormat(HEADER_FORMAT, MIN_SIZE);
      };
    ...
    namespace Version3
    {
      ...
      public:
        ...
        bool FastCheck() const
        {
          ...
          return Math::InRange(header.GetTotalSize(), sizeof(header), Data.Size());
        }
      ...
      Binary::Container::Ptr DecodeBlock(Binary::View data)
      {
        if (data.Size() >= sizeof(RawHeader))
        {
          const RawHeader& block = *data.As<RawHeader>();
  ...
  {
    return MakePtr<Hrust2::Version1::Decoder>();
  }

  Decoder::Ptr CreateHrust23Decoder()
  {
    return MakePtr<Hrust2::Version3::Decoder>();
  }
}  // namespace Formats::Packed
