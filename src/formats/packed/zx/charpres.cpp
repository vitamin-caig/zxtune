...
namespace Formats::Packed
{
  namespace CharPres
  {
    ...
    public:
      ...
      bool FastCheck() const
      {
        ...
        if (!CheckDataMovement(header.DepackerBodySrc + header.DepackerBodySize, header.PackedDataDst,
    ...
    {
    public:
      explicit ReverseByteStream(Binary::View data)
  ...
  {
    return MakePtr<CharPres::Decoder>();
  }
}  // namespace Formats::Packed
