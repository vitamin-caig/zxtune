...
namespace Formats::Packed
{
  namespace PowerfullCodeDecreaser6
  {
    ...
    public:
      ...
      Binary::View GetBitstream() const
      {
        return Data.SubView(offsetof(typename Version::RawHeader, Bitstream));
      }
    ...
    {
    public:
      explicit BitstreamDecoder(Binary::View data)
        : Stream(data)
      {}
    ...
    public:
      explicit DataDecoder(const Parser<Version>& parser)
        : BitstreamDecoder(parser.GetBitstream())
  ...
  {
    return MakePtr<PowerfullCodeDecreaser6::Decoder<PowerfullCodeDecreaser6::Version61> >();
  }

  Decoder::Ptr CreatePowerfullCodeDecreaser61iDecoder()
  {
    return MakePtr<PowerfullCodeDecreaser6::Decoder<PowerfullCodeDecreaser6::Version61i> >();
  }

  Decoder::Ptr CreatePowerfullCodeDecreaser62Decoder()
  {
    return MakePtr<PowerfullCodeDecreaser6::Decoder<PowerfullCodeDecreaser6::Version62> >();
  }
}  // namespace Formats::Packed
