...
namespace Formats
{
  namespace Chiptune
  {
    namespace Wav
    {
      ...
      const Guid ATRAC3PLUS = {{0xbf, 0xaa, 0x23, 0xe9, 0x58, 0xcb, 0x71, 0x44, 0xa1, 0x19, 0xff, 0xfa, 0x01, 0xe4, 0xce, 0x62}};
      const Guid ATRAC9 = {{0xd2, 0x42, 0xe1, 0x47, 0xba, 0x36, 0x8d, 0x4d, 0x88, 0xfc, 0x61, 0x65, 0x4f, 0x8c, 0x83, 0x6c}};
