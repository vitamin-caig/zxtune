/*
Abstract:
  ProTracker v2.xx format description
...
#pragma once
#ifndef FORMATS_CHIPTUNE_PROTRACKER2_H_DEFINED
#define FORMATS_CHIPTUNE_PROTRACKER2_H_DEFINED
  ...
  namespace Chiptune
  {
    namespace ProTracker2
    {
      struct Sample
      {
        struct Line
        {
          Line() : Level(), Noise(), ToneMask(), NoiseMask(), Vibrato()
          {
          }
