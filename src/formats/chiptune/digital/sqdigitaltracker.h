/*
Abstract:
  SQ-Tracker (Digital) format description
...
#pragma once
#ifndef FORMATS_CHIPTUNE_SQDIGITALRACKER_H_DEFINED
#define FORMATS_CHIPTUNE_SQDIGITALRACKER_H_DEFINED
...
#endif //FORMATS_CHIPTUNE_SQDIGITALRACKER_H_DEFINED
