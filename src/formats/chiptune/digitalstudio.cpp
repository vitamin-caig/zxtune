...
#pragma pack(pop)
  ...
  class StubBuilder : public Formats::Chiptune::DigitalStudio::Builder
  {
  public:
  ...
  class BuilderDelegate : public Formats::Chiptune::DigitalStudio::Builder
  {
  public:
    explicit BuilderDelegate(Formats::Chiptune::DigitalStudio::Builder& delegate)
      : Delegate(delegate)
    {
    }
  ...
  private:
    Formats::Chiptune::DigitalStudio::Builder& Delegate;
  };

  typedef std::set<uint_t> Indices;

  class StatisticCollectionBuilder : public BuilderDelegate
  {
  public:
    explicit StatisticCollectionBuilder(Formats::Chiptune::DigitalStudio::Builder& delegate)
    ...
    virtual void SetPositions(const std::vector<uint_t>& positions, uint_t loop)
    {
      ...
      return BuilderDelegate::SetPositions(positions, loop);
    }

    virtual void SetSample(uint_t sample)
    {
      UsedSamples.insert(sample);
      return BuilderDelegate::SetSample(sample);
    }
  ...
  public:
    ...
    void ParseCommonProperties(Formats::Chiptune::DigitalStudio::Builder& target) const
    {
      target.SetInitialTempo(Source.Tempo);
      target.SetTitle(FromCharArray(Source.Title));
    }

    void ParsePositions(Formats::Chiptune::DigitalStudio::Builder& target) const
    {
    ...
    void ParsePatterns(const Indices& pats, Formats::Chiptune::DigitalStudio::Builder& target) const
    {
    ...
    void ParseSamples(const Indices& sams, Formats::Chiptune::DigitalStudio::Builder& target) const
    {
  ...
  private:
    ...
    static bool ParseLine(const Pattern::Line& srcLine, Formats::Chiptune::DigitalStudio::Builder& target)
    {
    ...
    void ParseSample(std::size_t idx, const SampleInfo& info, Formats::Chiptune::DigitalStudio::Builder& target) const
    {
  ...
  public:
    ...
    {
      Formats::Chiptune::DigitalStudio::Builder& stub = Formats::Chiptune::DigitalStudio::GetStubBuilder();
      return Formats::Chiptune::DigitalStudio::Parse(rawData, stub);
    }
  private:
...
namespace Formats
{
  namespace Chiptune
  {
    namespace DigitalStudio
    {
      ...
      {
        if (!::DigitalStudio::FastCheck(data))
        {
        ...
        try
        {
          const ::DigitalStudio::Format format(data);

          format.ParseCommonProperties(target);

          ::DigitalStudio::StatisticCollectionBuilder statistic(target);
          format.ParsePositions(statistic);
          const ::DigitalStudio::Indices& usedPatterns = statistic.GetUsedPatterns();
          format.ParsePatterns(usedPatterns, statistic);
          const ::DigitalStudio::Indices& usedSamples = statistic.GetUsedSamples();
          format.ParseSamples(usedSamples, target);

          const Binary::Container::Ptr containerData = data.GetSubcontainer(0, format.GetSize());
          return boost::make_shared< ::DigitalStudio::Container>(containerData);
        }
      ...
      {
        static ::DigitalStudio::StubBuilder stub;
        return stub;
      }
    }
