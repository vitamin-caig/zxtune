  ...
  void RegisterWin32Backend(BackendsStorage& storage)
  {
    try
    {
      ...
      if (Win32::DevicesIterator(api).IsValid())
      {
        ...
        storage.Register(Win32::BACKEND_ID, Win32::DESCRIPTION, Win32::CAPABILITIES, factory);
      }
      else
      {
    ...
    {
      storage.Register(Win32::BACKEND_ID, Win32::DESCRIPTION, Win32::CAPABILITIES, e);
    }
  }
