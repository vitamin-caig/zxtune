...
namespace Devices
{
  namespace DAC
  {
    ...
    {
    public:
      BaseSample(Binary::DataView content, std::size_t loop)
    ...
    {
    public:
      U8Sample(Binary::DataView content, std::size_t loop)
    ...
    {
    public:
      U4Sample(Binary::DataView content, std::size_t loop)
        : BaseSample(content, loop)
      {
      }
    ...
    {
    public:
      U4PackedSample(Binary::DataView content, std::size_t loop)
        : BaseSample(content, loop)
      {
      }
