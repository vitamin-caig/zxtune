...
cd "build\%MPT_VS_WITHTARGET%" || goto error
 ...
 msbuild libopenmpt.sln /target:Build /property:Configuration=Release;Platform=%MPT_VS_ARCH%;XPDeprecationWarning=false /maxcpucount /verbosity:minimal || goto error
 ...
 msbuild libopenmpt.sln /target:Build /property:Configuration=ReleaseShared;Platform=%MPT_VS_ARCH%;XPDeprecationWarning=false /maxcpucount /verbosity:minimal || goto error
