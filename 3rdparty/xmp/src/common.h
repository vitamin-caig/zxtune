...
#if !defined(NO_VERSIONED_SYMBOLS) && !defined(WIN32) && !defined(ANDROID) && !defined(__APPLE__) && !defined(__AMIGA__) && !defined(B_BEOS_VERSION) && !defined(__ATHEOS__)
...
#define QUIRK_PRENV	(1 << 21)	/* Portamento resets envelope & fade */
